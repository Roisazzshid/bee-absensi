  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="mt-0.5 text-sm text-on-surface-variant">Pantau kehadiran seluruh karyawan</p>
      </div>
                ...
                <div key={item.id} className="rounded-2xl bg-white p-4 ring-1 ring-outline-variant/40 shadow-sm">
                  ...
                  <div className="mt-3 flex gap-4 text-xs text-on-surface-variant">
                    <span className="flex items-center gap-1">
                      <svg className="size-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>
