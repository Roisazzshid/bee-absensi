        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 rounded-xl py-2.5 text-sm font-bold transition-all cursor-pointer ${active
            ...
            {[
              {
                ...
                value: "roisazzam@lebahkreatif.or.id",
                action: "Kirim Email",
                href: "mailto:roisazzam@lebahkreatif.or.id",
                bg: "bg-blue-500/10 dark:bg-blue-500/20",
              ...
              },
              {
                ...
                value: "+62 895-4122-76357",
                action: "Chat WhatsApp",
                href: "https://wa.me/62895412276357",
                bg: "bg-amber-500/10 dark:bg-amber-500/20",
              ...
              },
              {
                ...
                href: "https://docs.google.com/document/d/1cqpKSNSer863yjk1fVC4Xt4CtYdjJkK8/edit?usp=sharing&ouid=108915273982663171516&rtpof=true&sd=true",
